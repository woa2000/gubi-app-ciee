    ...
    <Card className="relative overflow-hidden bg-gradient-to-br from-purple-500 via-purple-600 to-blue-600 border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
      ...
      <CardContent className="relative space-y-6 pb-6">
        ...
        <div className="space-y-3">
          <button
            onClick={openReport}
            className="group w-full relative overflow-hidden bg-white/90 hover:bg-white text-purple-700 font-semibold rounded-xl p-4 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
        ...
        <div className="grid grid-cols-3 gap-3 pt-2">
          <div className="text-center">
            ...
            <span className="text-xs text-purple-100">Perfil</span>
          </div>
          <div className="text-center">
            <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-1">
              <CheckCircle2 className="w-4 h-4 text-green-300" />
            </div>
            <span className="text-xs text-purple-100">Habilidades</span>
          </div>
          <div className="text-center">
            <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-1">
              <CheckCircle2 className="w-4 h-4 text-green-300" />
            </div>
            <span className="text-xs text-purple-100">Objetivos</span>
          </div>
        </div>
      </CardContent>
    </Card>
